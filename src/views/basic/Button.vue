<template>
  <div class="page-button">
    ...
    <re-dev-sheet>
      <re-dev-desc>帶 loading</re-dev-desc>
    ...
    <re-dev-sheet>
      <re-dev-desc>小 size</re-dev-desc>
      <re-button size="small"> 小按鈕 </re-button>
    </re-dev-sheet>

    <re-dev-sheet>
      <re-dev-desc>其他類型測試</re-dev-desc>
    ...
    <re-dev-sheet>
      <re-dev-desc>Button Group</re-dev-desc>
